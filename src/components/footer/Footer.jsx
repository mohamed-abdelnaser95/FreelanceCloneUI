        ...
        <div className="container">
            <div className="top">
                ...
                <div className="item">
                    ...
                    <span>Selling on Freelance Site</span>
                    <span>Buying on Freelance Site</span>
                </div>
                <div className="item">
                    <h2>Community</h2>
                ...
                <div className="item">
                    <h2>More From Freelance Website</h2>
            ...
            <div className="bottom">
                <div className="left">
                    ...
                    <span>© FreeLance Website International Ltd. 2023</span>
                </div>
                <div className="right">
